import{IW as Pe,IS as be,Jk as we,GW as f,I9 as w,IY as Ve,GX as H,GT as r,fg as j,wT as K,IV as De,HO as C,ge as ee,gf as T,hM as F,Jl as xe,fZ as te,I7 as ie,Ht as M,gV as m,h4 as v,Jm as ne,y$ as se,n as o,mr as ae,hL as Ee,i4 as ye,gg as Le,di as re,g3 as le,hJ as Se,IT as Ce,x5 as Me,Hr as Ae,Ih as $e,GS as B,em as Te,GZ as oe,G_ as ce,_ as he,pn as Re,ed as G,i5 as q,U as c,$ as z,jW as de,jU as pe,dn as Ie,dh as I,lJ as Oe,HC as qe,lM as Ue,Jn as je,Hc as D,J0 as ze,J1 as J,Jo as Ne,mp as We,Jp as R,Jq as He,h$ as Fe,u$ as Be,i1 as Ge,i2 as Je,i3 as ke,i6 as Xe,V as A,Jr as Ze,ef as k}from"./index-DYXqh4NY.js";import{t as Qe}from"./VisualElement-BX1e-H2l.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=j(6);function fe(t){const e=new K;e.include(De),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function $(t){return ae(it,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-j(2))))}function Ye(t,e){return m(O,t.pointDistanceOrigin,e.camera.viewMatrix),O[3]=te(t.pointDistanceOrigin,t.pointDistanceTarget),O}function Ke(t,e){const n=ye(t.lineVerticalPlaneSegment,.5,u),i=t.renderCoordsHelper.worldUpAtPosition(n,nt),s=T(V,t.lineVerticalPlaneSegment.vector),a=Le(u,i,s);return T(a,a),ge(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function et(t,e){const n=v(u,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function tt(t,e){const n=re(u,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function ge(t,e,n){return m(X,t,n),v(d,e),d[3]=0,ne(d,d,n),Ee(X,d,st)}const it=le(),u=o(),d=se(),nt=o(),V=o(),X=o(),st=Se(),O=se(),at=Object.freeze(Object.defineProperty({__proto__:null,build:fe,defaultAngleCutoff:N},Symbol.toStringTag,{value:"Module"}));function _e(t){const e=new K;e.include(ue,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Ce("modelView",(a,{camera:l})=>Me(lt,l.viewMatrix,a.origin)),new Ae("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new $e("pixelToNDC",({camera:a})=>ae(rt,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
