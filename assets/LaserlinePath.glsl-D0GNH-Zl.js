import{It as be,Ip as we,IK as De,Gz as f,HJ as w,Iy as Ve,GA as W,Gw as r,bY as z,xw as ee,Is as xe,Hn as E,d2 as te,d0 as A,hu as B,IL as Le,hW as ie,HH as ne,H1 as S,gm as _,c$ as v,IM as se,A5 as ae,n as o,mf as re,ht as ye,rQ as Ee,d3 as Se,de as le,fy as oe,hr as Ce,Iq as Me,xK as Ae,G$ as $e,HR as Re,Gv as F,c8 as Te,qP as ce,qR as he,_ as de,go as Ie,b$ as G,qi as q,ae as c,ah as j,jG as pe,gp as ue,cZ as Oe,d1 as O,lr as Ue,Hc as qe,lt as ze,IN as je,GL as V,oe as Ne,of as k,IO as He,md as We,IP as $,IQ as Be,wA as Q,rM as Fe,vk as Ge,rN as ke,rO as Qe,rP as Ke,rR as Xe,ag as C,IR as Ze,c1 as K}from"./index-Co51jUEc.js";import{t as Je}from"./VisualElement-D8ex9kgD.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new E("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=B(D),d)),new Le("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/B(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
