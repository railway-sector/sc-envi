import{xr as te,Hp as ie,Hq as re,G2 as ae,Hr as se,Hs as oe,G6 as o,Hi as ne,GB as ce,Hh as le,G5 as y,Ht as pe,Hu as de,GF as N,G4 as he,G7 as ve,G8 as ue,GZ as me,Ga as fe,Hv as R,Hw as E,Hx as ge,Hy as Se,GG as Pe,gl as ye,qK as _e,jC as we,qM as xe,_ as $e,qO as D,Gc as U,Gd as ze,Ge as q,qP as L,Gg as be,Gh as ke,Gj as Ve,Hz as Oe,HA as I,HB as B,HC as Te,HD as Ce,HE as We,$ as d,a2 as De,GI as Me,Gl as m,fX as Le,Gn as M,GL as je,HF as Y,s$ as Ge,H9 as He,HG as Fe,Go as Ae,d0 as K,kr as Ne,gi as Q,v as X,HH as Re}from"./index-fhCoIIZF.js";function Z(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:w}=r,f=a===2,k=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:S,varyings:g}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),g.add("vColor","vec4"),g.add("vpos","vec3",{invariant:!0}),g.add("vUV","vec2"),g.add("vSize","float"),_&&g.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return clamp(0.5 - pixelDistance, 0.0, 1.0);
  ...
  `)),e.include(Pe,r),e.include(E),S.main.add(o`
    ...
    outputColorHighlightOLID(applySlice(finalColor, vpos), finalColor.rgb);`),e}const Ee=Object.freeze(Object.defineProperty({__proto__:null,build:Z},Symbol.toStringTag,{value:"Module"}));let j=class extends _e{constructor(e,a){super(e,a,we(J(a))),this.shader=new xe(Ee,()=>$e(()=>Promise.resolve().then(()=>Ke),void 0))}_makePipelineState(e,a){const{output:t,space:_,hasOccludees:w}=e;return D({blending:Ve(t,!1,e.emissionDimmingPass),depthTest:_===0?null:ke(t),depthWrite:be(e),colorWrite:L,stencilWrite:w?q:null,stencilTest:w?a?U:ze:null,polygonOffset:{factor:0,units:-10}})}initializePipeline(e){return e.occluder?(this._occluderPipelineTransparent=D({blending:B,depthTest:I,depthWrite:null,colorWrite:L,stencilWrite:null,stencilTest:Oe}),this._occluderPipelineOpaque=D({blending:B,depthTest:I,depthWrite:null,colorWrite:L,stencilWrite:Ce,stencilTest:Te}),this._occluderPipelineMaskWrite=D({blending:null,depthTest:We,depthWrite:null,colorWrite:null,stencilWrite:q,stencilTest:U})):this._occluderPipelineTransparent=this._occluderPipelineOpaque=this._occluderPipelineMaskWrite=null,this._occludeePipelineState=this._makePipelineState(e,!0),this._makePipelineState(e,!1)}getPipeline(e,a,t){return t?this._occludeePipelineState:e.occluder===11?this._occluderPipelineTransparent??super.getPipeline(e,a,t):e.occluder===10?this._occluderPipelineOpaque??super.getPipeline(e,a,t):this._occluderPipelineMaskWrite??super.getPipeline(e,a,t)}};function J(r){const e=ye().vec3f("position").vec4f16("previousDelta").vec2f16("uv0");return r.hasVVColor?e.f32("colorFeatureAttribute"):e.vec4u8("color",{glNormalized:!0}),r.hasVVOpacity&&e.f32("opacityFeatureAttribute"),r.hasVVSize?e.f32("sizeFeatureAttribute"):e.f16("size"),r.worldSpace&&e.vec3f16("normal"),e.freeze()}j=d([De("esri.views.3d.webgl-engine.shaders.LineMarkerTechnique")],j);class h extends Me{constructor(e){super(),this.spherical=e,this.space=1,this.anchor=0,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.hasVVSize=!1,this.hasVVColor=!1,this.hasVVOpacity=!1,this.hasOccludees=!1,this.hasScreenSizePerspective=!1,this.textureCoordinateType=0,this.emissionSource=0,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVVInstancing=!1,this.hasSliceTranslatedView=!0,this.olidColorInstanced=!1,this.overlayEnabled=!1,this.snowCover=!1}get draped(){return this.space===0}get worldSpace(){return this.space===2}}d([m({count:3})],h.prototype,"space",void 0),d([m({count:2})],h.prototype,"anchor",void 0),d([m()],h.prototype,"occluder",void 0),d([m()],h.prototype,"writeDepth",void 0),d([m()],h.prototype,"hideOnShortSegments",void 0),d([m()],h.prototype,"hasCap",void 0),d([m()],h.prototype,"hasTip",void 0),d([m()],h.prototype,"hasVVSize",void 0),d([m()],h.prototype,"hasVVColor",void 0),d([m()],h.prototype,"hasVVOpacity",void 0),d([m()],h.prototype,"hasOccludees",void 0),d([m()],h.prototype,"hasScreenSizePerspective",void 0);class Ze extends Le{constructor(e,a){super(e,qe),this.produces=new Map([[2,t=>t===10||M(t)&&this.parameters.renderOccluded===8],[3,t=>je(t)],[10,t=>Y(t)&&this.parameters.renderOccluded===8],[11,t=>Y(t)&&this.parameters.renderOccluded===8],[4,t=>M(t)&&this.parameters.writeDepth],[8,t=>M(t)&&!this.parameters.writeDepth],[18,t=>M(t)||t===10]]),this.intersectDraped=void 0,this._configuration=new h(a)}updateConfiguration(e){super.updateConfiguration(e),this._configuration.space=e.slot===18?0:this.parameters.worldSpace?2:1,this._configuration.hideOnShortSegments=this.parameters.hideOnShortSegments,this._configuration.hasCap=this.parameters.cap!==0,this._configuration.anchor=this.parameters.anchor,this._configuration.hasTip=this.parameters.hasTip,this._configuration.hasSlicePlane=this.parameters.hasSlicePlane,this._configuration.hasOccludees=e.hasOccludees,this._configuration.writeDepth=this.parameters.writeDepth,this._configuration.hasVVSize=this.parameters.hasVVSize,this._configuration.hasVVColor=this.parameters.hasVVColor,this._configuration.hasVVOpacity=this.parameters.hasVVOpacity,this._configuration.occluder=this.parameters.renderOccluded===8,this._configuration.hasScreenSizePerspective=this.parameters.screenSizePerspective!=null}get visible(){return this.parameters.color[3]>=Ge}intersect(){}createBufferWriter(){return new Ie(J(this.parameters),this.parameters)}createGLMaterial(e){return new Ue(e)}}class Ue extends Ae{dispose(){super.dispose(),this._markerTextures?.release(this._markerPrimitive),this._markerPrimitive=null}beginSlot(e){const a=this._material.parameters.markerPrimitive;return a!==this._markerPrimitive&&(this._material.setParameters({markerTexture:this._markerTextures.swap(a,this._markerPrimitive)}),this._markerPrimitive=a),this.getTechnique(j,e)}}class qe extends He{constructor(){super(...arguments),this.width=0,this.color=[1,1,1,1],this.markerPrimitive="arrow",this.placement="end",this.cap=0,this.anchor=0,this.hasTip=!1,this.worldSpace=!1,this.hideOnShortSegments=!1,this.writeDepth=!0,this.hasSlicePlane=!1,this.vvFastUpdate=!1,this.stipplePattern=null,this.markerTexture=null}}class Ie{constructor(e,a){this.layout=e,this._parameters=a}elementCount(){return this._parameters.placement==="begin-end"?12:6}write(e,a,t,_,w){if(w==null)return;const{buffer:f,offset:k}=w,i=t.get("position").data,S=i.length/3;let g=[1,0,0];const l=t.get("normal");this._parameters.worldSpace&&l!=null&&(g=l.data);let c=1,G=0;this._parameters.vvSize?G=t.get("sizeFeatureAttribute").data[0]:t.has("size")&&(c=t.get("size").data[0]);let $=[1,1,1,1],H=0;this._parameters.vvColor?H=t.get("colorFeatureAttribute").data[0]:t.has("color")&&($=t.get("color").data);let F=0;this._parameters.vvOpacity&&(F=t.get("opacityFeatureAttribute").data[0]);const x=new Float32Array(f.buffer),P=Fe(f.buffer),V=new Uint8Array(f.buffer);let p=k*(this.layout.stride/4);const z=x.BYTES_PER_ELEMENT/P.BYTES_PER_ELEMENT,ee=4/z,b=(n,T,v,u)=>{x[p++]=n[0],x[p++]=n[1],x[p++]=n[2],Re(T,n,P,p*z),p+=ee;let s=p*z;if(P[s++]=v[0],P[s++]=v[1],p=Math.ceil(s/z),this._parameters.vvColor)x[p++]=H;else{const C=Math.min(4*u,$.length-4),W=4*p++;V[W]=255*$[C],V[W+1]=255*$[C+1],V[W+2]=255*$[C+2],V[W+3]=255*$[C+3]}this._parameters.vvOpacity&&(x[p++]=F),s=p*z,this._parameters.vvSize?(x[p++]=G,s+=2):P[s++]=c,this._parameters.worldSpace&&(P[s++]=g[0],P[s++]=g[1],P[s++]=g[2]),p=Math.ceil(s/z)},A=(n,T)=>{const v=K(Be,i[3*n],i[3*n+1],i[3*n+2]),u=Ye;let s=n+T;do K(u,i[3*s],i[3*s+1],i[3*s+2]),s+=T;while(Ne(v,u)&&s>=0&&s<S);e&&(Q(v,v,e),Q(u,u,e)),b(v,u,[-1,-1],n),b(v,u,[1,-1],n),b(v,u,[1,1],n),b(v,u,[-1,-1],n),b(v,u,[1,1],n),b(v,u,[-1,1],n)},O=this._parameters.placement;O!=="begin"&&O!=="begin-end"||A(0,1),O!=="end"&&O!=="begin-end"||A(S-1,-1)}}const Be=X(),Ye=X(),Ke=Object.freeze(Object.defineProperty({__proto__:null,build:Z},Symbol.toStringTag,{value:"Module"}));export{Ze as g};
