import{wT as ee,If as te,Ig as ie,GQ as re,GO as ae,Ih as se,Ii as oe,GT as o,I8 as ne,Hr as ce,I7 as le,GS as _,Ij as pe,Ik as de,Hv as j,GR as he,GU as ve,GV as ue,HO as me,GX as fe,Il as N,Im as U,In as ge,Io as Se,Hw as Pe,jU as ye,GZ as we,jW as _e,G_ as ze,_ as xe,G$ as L,H0 as R,H1 as $e,H2 as E,H3 as M,Hy as be,H5 as Te,H6 as Ve,H7 as ke,H9 as V,Ha as Oe,Ip as De,Iq as G,Ir as B,Is as We,It as Ce,Iu as Le,U as c,$ as Me,Hb as Ie,Hc as d,gB as Ae,Hz as He,Iv as q,rP as Fe,H_ as je,Iw as Ne,Hf as Ue,dh as Q,kZ as Re,gV as Y,n as Z,Ix as Ee}from"./index-DYXqh4NY.js";function X(t){const e=new ee,{space:r,anchor:i,hasTip:P,hasScreenSizePerspective:z}=t,u=r===2,g=r===1;e.include(te,t),e.include(ie,t),e.include(re,t);const{vertex:a,fragment:S,varyings:y}=e;ae(a,t),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new se("nearFar",({camera:p})=>p.nearFar),new oe("viewport",({camera:p})=>p.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
}`),P&&(e.include(U),S.constants.add("relativeMarkerSize","float",ge/N).constants.add("relativeTipLineWidth","float",Se).code.add(o`
