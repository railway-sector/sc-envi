import{JV as be,JR as we,Ka as De,H$ as f,J9 as w,J_ as Ve,I0 as H,HY as r,c2 as j,xR as ee,JU as xe,IP as L,d8 as te,d6 as A,hA as F,Kb as ye,i0 as ie,J7 as ne,It as S,gs as _,d5 as v,Kc as se,Ab as ae,n as o,mA as re,hz as Ee,s9 as Le,d9 as Se,dk as le,fE as oe,hx as Ce,JS as Me,y3 as Ae,Ir as $e,Jh as Re,HX as B,ce as Te,r8 as ce,ra as he,_ as de,gu as Ie,c5 as G,qD as z,ak as c,an as q,jM as pe,gv as ue,d3 as Oe,d7 as O,lM as Ue,IE as ze,lO as je,Kd as qe,Ib as V,oz as Ne,oA as J,Ke as We,my as He,Kf as $,Kg as Fe,wV as K,s5 as Be,vF as Ge,s6 as Je,s7 as Ke,s8 as ke,sa as Xe,am as C,Kh as Qe,c7 as k}from"./index-JFoSnkD6.js";import{t as Ye}from"./VisualElement-B7dlVuYd.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
